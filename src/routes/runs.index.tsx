    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative flex min-h-[50vh] flex-col justify-end overflow-hidden pt-32 pb-16 md:min-h-[60vh] md:pb-24">
        <div className="mx-auto w-full max-w-[1400px] px-5 md:px-8">
          ...
          <h1 className="display mt-4 text-5xl md:text-8xl">Our Weekly Runs</h1>
      ...
      <section className="border-t border-border px-5 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-[1400px] space-y-12">
          {runs.map((run, i) => (
            <div
              key={run.slug}
              className="grid overflow-hidden rounded-3xl border border-border bg-card/60 transition-colors hover:border-white/25 md:grid-cols-12"
            >
              {/* Image */}
              <div className="relative aspect-16/10 md:col-span-5 md:aspect-auto">
                ...
                />
                <div className="absolute left-4 top-4 rounded-full bg-background/80 px-3 py-1 text-xs font-mono backdrop-blur">
                  {run.schedule}
                </div>
              </div>
              ...
              <div className="flex flex-col justify-between p-8 md:col-span-7 md:p-12">
                <div>
                  ...
                  <h2 className="display mt-4 text-4xl md:text-5xl">{run.name}</h2>
                  <p className="mt-4 text-white/75 leading-relaxed">{run.overview}</p>

                  {/* Quick specs */}
                  <div className="mt-8 grid grid-cols-2 gap-4 border-t border-border/60 pt-6 sm:grid-cols-3">
                    <div>
                      <p className="tech text-white/40">Meeting Spot</p>
                      <p className="mt-1 text-sm font-medium">{run.meeting}</p>
                    </div>
                    <div>
                      <p className="tech text-white/40">Pace</p>
                      <p className="mt-1 text-sm font-medium">{run.pace}</p>
                    </div>
                    <div className="col-span-2 sm:col-span-1">
                      <p className="tech text-white/40">Frequency</p>
                      <p className="mt-1 text-sm font-medium">{run.schedule}</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-10 md:grid-cols-3">
            <div className="rounded-2xl border border-border p-8 bg-background">
              <div className="tech text-[#ff0000]">01. Timing</div>
              <h3 className="display mt-3 text-2xl">Arrive by 06:20 AM</h3>
            ...
            <div className="rounded-2xl border border-border p-8 bg-background">
              <div className="tech text-[#ff0000]">02. Gear</div>
              <h3 className="display mt-3 text-2xl">Road Shoes &amp; Water</h3>
              <p className="mt-3 text-sm text-white/70 leading-relaxed">
            ...
            <div className="rounded-2xl border border-border p-8 bg-background">
              <div className="tech text-[#ff0000]">03. Pace</div>
              <h3 className="display mt-3 text-2xl">Conversational &amp; Inclusive</h3>
              <p className="mt-3 text-sm text-white/70 leading-relaxed">
