    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative flex min-h-[50vh] flex-col justify-end overflow-hidden pt-32 pb-16 md:min-h-[60vh] md:pb-24">
        <div className="mx-auto w-full max-w-[1400px] px-5 md:px-8">
          ...
          <h1 className="display mt-4 text-5xl md:text-8xl">Kigali Runner's Guide</h1>
        ...
        <div className="mx-auto grid max-w-[1400px] gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-8 space-y-16">
            ...
            <article className="space-y-6">
              <span className="tech text-[#ff0000]">Chapter 01</span>
              <h2 className="display text-3xl md:text-4xl">Running at 1,500m Altitude</h2>
              ...
              <div className="rounded-2xl border border-border bg-card/50 p-6 space-y-3">
                <h4 className="font-semibold text-white">How to Acclimate:</h4>
            ...
            <article className="space-y-6 border-t border-border pt-12">
              <span className="tech text-[#ff0000]">Chapter 02</span>
              <h2 className="display text-3xl md:text-4xl">Mastering the Thousand Hills</h2>
              <p className="text-white/80 leading-relaxed">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-border bg-card/40 p-6">
                  <h4 className="font-semibold text-white">Uphill Technique:</h4>
                ...
                <div className="rounded-2xl border border-border bg-card/40 p-6">
                  <h4 className="font-semibold text-white">Downhill Technique:</h4>
                  <p className="mt-2 text-xs text-white/70 leading-relaxed">
            ...
            <article className="space-y-6 border-t border-border pt-12">
              <span className="tech text-[#ff0000]">Chapter 03</span>
              <h2 className="display text-3xl md:text-4xl">Kigali Car Free Day</h2>
              <p className="text-white/80 leading-relaxed">
            ...
            <article className="space-y-6 border-t border-border pt-12">
              <span className="tech text-[#ff0000]">Chapter 04</span>
              <h2 className="display text-3xl md:text-4xl">Safety, Lighting &amp; Etiquette</h2>
              <p className="text-white/80 leading-relaxed">
          ...
          <div className="md:col-span-4 space-y-6">
            <div className="sticky top-28 space-y-6">
              <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
                <span className="tech text-[#ff0000]">Quick Links</span>
                <h3 className="display mt-2 text-2xl">Explore More</h3>
                <div className="mt-4 flex flex-col gap-3 text-sm text-white/80">
                  <Link to="/routes" className="hover:text-[#ff0000] transition-colors">
                    → Curated Kigali Routes
                  </Link>
                  <Link to="/runs" className="hover:text-[#ff0000] transition-colors">
                    → Weekly Run Formats
                  </Link>
                  <Link to="/schedule" className="hover:text-[#ff0000] transition-colors">
                    → Sunday Schedule
                  </Link>
                  <Link to="/faq" className="hover:text-[#ff0000] transition-colors">
              ...
              <div className="rounded-2xl border border-border bg-background p-6">
                <span className="tech text-[#ff0000]">Join Us This Sunday</span>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="snap-btn mt-4 w-full text-center text-xs"
                >
                  Register Free
                </a>
              </div>
